...
def load_model():
    ...
    """
    global MODEL
    MODEL = mlflow.sklearn.load_model(model_uri="models:/sk-learn-K Nearest Neighbour-reg-model/Production")
    logging.info("Successfully loaded model sk-learn-K Nearest Neighbour-reg-model from MLFlow")
